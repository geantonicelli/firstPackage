...
#' function to discard very poorly conserved regions from a sequences alignment before building a phylogenetic tree
#'
...
#' this function takes an alignment in phylip format made by an alignment software like clustal omega and clean the alignment based on a defined percentage of non-gap positions and a defined percentage of sequence identity between all sequences considered for phylogenetic analysis
#'
#' @param alignment object of type alignment in phylip format with the aligned sequences to be
#'   checked for similarity and cleaned. A file in format phylip is generated by an alignment software from
#'   a .fasta file containing the sequences and loaded to the R environment
#' @param minpcnongap integer for the desired minimal percentage of non-gap positions between alignments for each position being analysed
#' @param minpcid integer for the desired minimal percentage of sequence identity between alignments for each position being analysed
#'
